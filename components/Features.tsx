...
export const Features = () => {
  return (
    <section id="features" className="py-24 bg-surface-subtle/80 dark:bg-slate-950/50 border-y border-border/60">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="glass p-8 rounded-3xl hover:bg-muted/50 dark:hover:bg-white/10 transition-colors group"
            >
